...
``docker run ghcr.io/medizininformatik-initiative/gemtex/snomed-postprocessing:1.2.4 create-concepts-dump --help`` for further information. ***[2]***  
...
docker run
 ...
 --rm
 ghcr.io/medizininformatik-initiative/gemtex/snomed-postprocessing:1.2.4
...
#### Docker
```
docker run --rm -p HOST_PORT:8501 ghcr.io/medizininformatik-initiative/gemtex/snomed-postprocessing:1.2.4 start-gui
```
